...
interface AlgoVisualSortFunctionBarProps {
...
class AlgoVisualSortFunctionBar extends Component<AlgoVisualSortFunctionBarProps> {
    render() {
        return (
                ...
                <div>
                    ...
                    <RangeSlider
                        ...
                        onChange={(changeEvent: ChangeEvent<HTMLInputElement>) => {
                            const delay = 300 - (parseInt(changeEvent.target.value) * 50);
